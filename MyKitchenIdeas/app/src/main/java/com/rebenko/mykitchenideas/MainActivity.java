...
public class MainActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    final String ADD_IND_ID = "ca-app-pub-9595835527986323/8712892675";
    final String DIR_SD = "Kitchen";
    final String FILE_SD = "kitchen";
    final String APP_NAME = "100 Kitchen Storage Ideas";
    final String APP_URL = "https://play.google.com/store/apps/details?id=com.rebenko.mykitchenideas";
    ...
    final String MORE_IDEAS_RUS_URL = "http://kitchen-idea.ru/";
