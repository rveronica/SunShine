package com.rebenko.gardengazebos;
...
public class MainActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    final String ADD_IND_ID = "ca-app-pub-9595835527986323/1337398670";
    final String DIR_SD = "garden_gazebos";
    final String FILE_SD = "gazebo";
    final String APP_NAME = "100 Garden Gazebos";
    final String APP_URL = "https://play.google.com/store/apps/details?id=com.rebenko.gardengazebos";
